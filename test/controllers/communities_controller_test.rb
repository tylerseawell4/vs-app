...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { activity: @community.activity, description: @community.description, gamertag: @community.gamertag }
    end
  ...
  test "should update community" do
    patch :update, id: @community, community: { activity: @community.activity, description: @community.description, gamertag: @community.gamertag }
    assert_redirected_to community_path(assigns(:community))
  end
